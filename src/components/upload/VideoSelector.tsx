...
export default function VideoSelector({ handleSelectFile }) {
  ...
  return (
    <div className=" h-[80vh] xl:max-h-screen flex items-center justify-center ">
      <div className="w-[650px] h-[400px] border border-dashed border-gray-600 flex items-center justify-center gap-4 flex-col rounded-lg">
        <input
          type="file"
          id="fileInput"
